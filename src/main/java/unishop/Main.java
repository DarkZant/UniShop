...
public class Main {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (choix == 6)
                            break;
                        switch (choix) {
                            case 1 -> System.out.println("\n" + p.liker(connectedUser.getUsername()));
                            case 2 -> {
                                if (p.getQuantite() == 0) {
            ...
            switch (choix) {
                case 1 -> {
                    switch (cmd.confirmerLivraison()) {
                        case 0 -> {
                            ...
                            cmd.saveAfter(USERS_PATH + ACHETEURS + connectedUser.getUsername() + "/Commandes/");
                ...
                case 2 -> {
                    ...
                    try {
                        ...
                        Billet b = new Billet(p.getId(), connectedUser.getUsername(), p.titre, a, estRetour, false,
                                "", produitRempla, false);
            ...
            case 2 -> {
                try {
                    ...
                    Commande c = acheteurConnecte.panier.passerCommande(USERS_PATH + ACHETEURS +
                            connectedUser.getUsername() + "/Commandes", adresse);
    ...
    static void offrirProduit() {
        ...
        try {
            ...
            Produit p = new Produit(connectedUser.getUsername(), titre, description, prix, quantite, points, images, videos,
    ...
    static void modifierProduit () {
        while (true) {
            ...
            if (choix == 3)
                return;
            Produit p = revendeurConnecte.getProduitAvecChoix();
            if (choix == 1) {
    ...
    static void ecrireEvaluation (Produit p) {
        ...
        try {
            ...
            p.addEvaluation(new Evaluation(connectedUser.getUsername(), note, comment));
